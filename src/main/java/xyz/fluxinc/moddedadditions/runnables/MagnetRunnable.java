...
public class MagnetRunnable implements Runnable {
    ...
    public MagnetRunnable(Player player) {
        this.player = player;
        this.xRadius = 16; this.yRadius = 16; this.zRadius = 16;
    }

    public MagnetRunnable(Player player, int radius) {
        this.player = player;
        this.xRadius = radius; this.yRadius = radius; this.zRadius = radius;
    }

    public MagnetRunnable(Player player, int xRadius, int yRadius, int zRadius) {
        this.player = player;
        this.xRadius = xRadius; this.yRadius = yRadius; this.zRadius = zRadius;
    }
