...
public class BootsItem extends CustomItem {

    private final Material craftingMaterial;

    public BootsItem(int modelId, Material material, Material craftingMaterial, String keyName, String displayName, String loreKey) {
